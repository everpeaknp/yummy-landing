...
const fallbackData: Partial<ProcessData> = {
  ...
  subtitle: "The fastest setup in the industry. Go live within minutes using our intuitive onboarding process.",
  steps: fallbackSteps,
};
          ...
          {steps.sort((a, b) => a.order - b.order).map((step, idx) => (
            <motion.div
              ...
              className={`
                 ...
                 ${step.isHighlighted ? 'shadow-2xl shadow-blue-900/20' : 'shadow-lg hover:shadow-xl'}
              `}
              style={{
            ...
            >
              ...
              <div 
                 ...
                 style={{ 
                    ...
                    color: step.isHighlighted ? '#ffffff' : step.iconColor
                 }}
              >
              ...
              <div className="relative z-10 mt-auto">
                <h3 
                    ...
                    style={{ color: step.isHighlighted ? '#ffffff' : (isDark ? '#ffffff' : '#0f172a') }}
                >
                  {step.title}
                </h3>
                <p 
