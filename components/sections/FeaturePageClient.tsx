  ...
  'smart-inventory': [
    {
      ...
      image:
        'https://images.unsplash.com/photo-1556740758-90de29cf1374?q=80&w=2500&auto=format&fit=crop',
      content: (
        <FeatureContent
    ...
    },
    {
      ...
      image:
        'https://images.unsplash.com/photo-1615897577741-9257d0796371?q=80&w=2500&auto=format&fit=crop',
      quote: {
    ...
    },
    {
      ...
      image:
        'https://images.unsplash.com/photo-1554224155-6726b3ff858f?q=80&w=2500&auto=format&fit=crop',
      content: (
        <FeatureContent
  ...
  'ird-billing': [
    {
      ...
      image:
        'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?q=80&w=2500&auto=format&fit=crop',
      content: (
        <FeatureContent
          title="Peace of Mind"
    ...
    },
    {
      ...
      image:
        'https://images.unsplash.com/photo-1556742049-0cfed4f7a07d?q=80&w=2500&auto=format&fit=crop',
      quote: {
        text: "Billing used to be a headache. Now it's just one click.",
        author: 'Owner, Cafe Himalayan',
      },
      content: (
        <FeatureContent
          title="Fast & Reliable"
  ...
  'qr-menu': [
    {
      ...
      image:
        'https://images.unsplash.com/photo-1595079676339-1534801fafde?q=80&w=2500&auto=format&fit=crop',
      quote: {
        text: 'Customers love scanning the QR. It feels modern and hygienic.',
        author: 'Manager, Burger House',
      },
      content: (
        <FeatureContent
          title="Scan & Order"
    ...
    },
    {
      ...
      image:
        'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?q=80&w=2500&auto=format&fit=crop',
      content: (
        <FeatureContent
  ...
  reports: [
    {
      ...
      content: (
        <FeatureContent
          ...
          features={['Daily sales summaries', 'Hourly sales heatmaps', 'Category-wise breakdown']}
        />
      ),
    },
    {
...
interface FeaturePageClientProps {
  featureData: FeaturePageData | null
  slug: string
}

export function FeaturePageClient({ featureData, slug }: FeaturePageClientProps) {
  const { theme } = useTheme()
  const isDark = theme === 'dark'

  const fallbackSections = featuresData[slug]

  if (!featureData && !fallbackSections) {
    return (
      <>
        <Navbar />
        <motion.main
