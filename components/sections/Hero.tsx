...
const fallbackData: Partial<HeroData> = {
  ...
  subheadline: "The #1 Restaurant OS in Nepal. IRD Approved Billing, Inventory, and KOT. Stop worrying about operations and focus on your food.",
  buttons: [
    { text: "Start Free Trial", href: "/pricing", type: "primary", icon: null, successText: "Launching...", order: 1 },
    { text: "How it Works", href: "#about", type: "secondary", icon: "arrow_forward", successText: "", order: 2 },
  ],
  badgeColors: {
  ...
  return (
    <header className="pt-32 pb-20 lg:pt-48 lg:pb-32 text-center max-w-7xl mx-auto px-6">
      ...
      <div 
        ...
        style={{ 
          backgroundColor: isDark ? (badgeColors as any).dark?.background : (badgeColors as any).light?.background, 
      ...
      >
        ...
        <span>{badge.text} {badge.emoji}</span>
      </div>
      ...
      >
        {headline.line1} <br />
        {headline.line2} <span style={{ color: headline.highlightColor }}>{headline.highlightWord}</span>
      </h1>
