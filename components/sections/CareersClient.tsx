...
import {
  jobPositions as fallbackJobPositions,
...
const fallbackData: Partial<CareersPageData> = {
  ...
  emptyState: {
    ...
    message: "We couldn't find any open roles matching your search.",
  },
          ...
          <div className="mb-12 space-y-6">
            ...
            <div className="relative max-w-2xl mx-auto">
              ...
              <input
                type="text"
                placeholder={
                  data.searchPlaceholder || 'Search for roles (e.g. Engineer, Design)...'
                }
                value={searchQuery}
